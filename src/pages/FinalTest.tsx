  ...
  return (
    <div className="page">
      ...
      <p className="subtitle">
        This comprehensive test covers all {course.modules.length} modules. You need 70% to pass and earn your certificate.
        Take your time!
      </p>
      <Quiz
        title="C# & ASP.NET Mastery — Final Assessment"
