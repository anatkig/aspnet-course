...
const levelDescriptions: Record<Level, string> = {
  'Beginner': 'You\'re just getting started with C# and ASP.NET. We recommend beginning from Module 1 and working through the entire course.',
  'Intermediate': 'You know the basics! Focus on Modules 3–5 to strengthen your understanding of OOP, LINQ, and async programming.',
  'Advanced': 'Solid foundation! Check out Modules 6–8 covering ASP.NET Core middleware, Entity Framework, and Web API design.',
  'Proficient': 'You have strong C#/ASP.NET skills. Review Modules 9–12 for advanced patterns like SignalR, Blazor, and microservices, then take the final test.',
  'Highly Proficient': 'Excellent C# & ASP.NET knowledge! You can go straight to the final test, or browse specific topics for a refresher.',
};
  ...
  return (
    <div className="page">
      ...
      <p className="subtitle">
        30 randomly selected questions to evaluate your C# & ASP.NET proficiency level.
      ...
      {!progress.levelTestResult && (
        <Quiz
          key={questions[0]?.id}
          title="C# & ASP.NET Knowledge Assessment"
          questions={questions}
