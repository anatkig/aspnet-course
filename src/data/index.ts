...
export const course: Course = {
  title: 'C# & ASP.NET Mastery',
  description:
    'A comprehensive course covering everything from C# fundamentals to ASP.NET Core, Entity Framework, authentication, testing, and deployment best practices.',
